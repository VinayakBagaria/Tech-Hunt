...
public class MainActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mDatabase.child("initialValue2").addValueEventListener(new ValueEventListener() {
            @Override
        ...
        mDatabase.child("stage2").addValueEventListener(new ValueEventListener() {
            @Override
            public void onDataChange(DataSnapshot dataSnapshot) {
    ...
    public void firstClick(View view)
    {
        ...
        if(et.getText().toString().trim().equalsIgnoreCase("animals"))
        {
            ...
            if(childCount!=-1 && childCount<Integer.parseInt(initialCount))
            {
                ...
                addRemove.addUser("stage2",androidId);
